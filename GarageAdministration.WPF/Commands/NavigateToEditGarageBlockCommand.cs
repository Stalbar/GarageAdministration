...
public class NavigateToEditGarageBlockCommand: CommandBase
{
    ...
    public NavigateToEditGarageBlockCommand(INavigationService navigation, GarageMapCanvasBlockItemViewModel garageMapCanvasBlockItemViewModel, GarageBlockStore garageBlockStore, GaragesStore garagesStore, GarageMapInfoStore garageMapInfoStore)
    {
    ...
    public override void Execute(object? parameter)
    {
        ...
        var editGarageViewModel = new EditBlockViewModel(garageBlock, _garageBlockStore, _garagesStore, _garageMapInfoStore, _navigation);
