...
public class CreateGarageUpdateMapCommand: CommandBase
{
    ...
    public override void Execute(object? parameter)
    {
        ...
        var mapInfo = new GarageMapInfo(mapInfoId, mousePos.Y, mousePos.X, _createGarageViewModel.GarageFormViewModel.Width, _createGarageViewModel.GarageFormViewModel.Height);
